...
public class AlertView {
    ...
    public AlertView(String title, String msg, String cancel, String[] others, String[] destructive, Context context, Style style, OnItemClickListener onItemClickListener) {
    ...
    public AlertView(String[] others, String[] destructive, Context context, Style style, OnItemClickListener onItemClickListener) {
        this(null, null, "取消", others, destructive, context, style, onItemClickListener);
    }
    ...
    protected void initListView() {
        ...
        AlertViewAdapter adapter = new AlertViewAdapter(mOthers, mDestructive);
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_actionsheet_new, contentContainer);
        initHeaderView(viewGroup);
        initContainerView(viewGroup, layoutInflater);
//        initListView();
    ...
    private void initContainerView(ViewGroup viewGroup, LayoutInflater inflater) {
        int buttonHeight = context.getResources().getDimensionPixelSize(R.dimen.height_alert_button);
        int dividerHeight = context.getResources().getDimensionPixelSize(R.dimen.size_divier);
        int textSize = context.getResources().getDimensionPixelSize(R.dimen.textSize_alert_button);
        ...
        for (int i = 0; i < mOthers.size(); i++) {
            TextView tvAlert = new TextView(context);
            tvAlert.setText(mOthers.get(i));
            tvAlert.setGravity(Gravity.CENTER);
            tvAlert.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
            ...
            tvAlert.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null)
                        onItemClickListener.onItemClick(AlertView.this, finalI);
                    dismiss();
                }
            });
            linearLayout.addView(tvAlert, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, buttonHeight));
            View divider = new View(context);
            divider.setBackgroundColor(context.getResources().getColor(R.color.bgColor_divier));
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, dividerHeight);
            linearLayout.addView(divider, params);
