...
public class FieldUtils {
        ...
        try {
            ...
            if (set != null) {
                ...
                if (type == String.class) {
                    ...
                    set.invoke(
                            entity,
                            value == null ? null : Integer.parseInt(value.toString()));
                } else if (type == float.class || type == Float.class) {
                    set.invoke(
                            entity,
                            value == null ? null : Float.parseFloat(value.toString()));
                } else if (type == long.class || type == Long.class) {
                    set.invoke(
                            entity,
                            value == null ? null : Long.parseLong(value.toString()));
    ...
    public static String getColumnByField(Field field) {
        ...
        if (oneToMany != null && oneToMany.manyColumn().trim().length() != 0) {
    ...
    public static boolean getIndex(Field field) {
        Index index = field.getAnnotation(Index.class);
        return index != null;
    }

    public static boolean getUnique(Field field) {
        Property property = field.getAnnotation(Property.class);
        if (property == null) {
            return false;
        }
