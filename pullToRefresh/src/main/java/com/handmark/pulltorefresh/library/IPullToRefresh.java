...
public interface IPullToRefresh<T extends View> {
	 ...
	 * when using <code>PtrMode.BOTH</code>.
	 * 
	 * @return PtrMode that the view is currently in
	 */
	public PullToRefreshBase.PtrMode getCurrentMode();
	 ...
	 * <code>PtrMode.BOTH</code>, you can use <code>getCurrentMode()</code> to
	 * check which mode the view is currently in
	 * 
	 * @return PtrMode that the view has been set to
	 */
	public PullToRefreshBase.PtrMode getMode();
	 ...
	 */
	public PullToRefreshBase.PtrState getState();
	...
	/**
	 * Set the ptrMode of Pull-to-Refresh that this view will use.
	 * 
	 * @param ptrMode - PtrMode to set the View to
	 */
	public void setMode(PullToRefreshBase.PtrMode ptrMode);
