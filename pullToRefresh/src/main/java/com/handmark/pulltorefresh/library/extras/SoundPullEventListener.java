...
public class SoundPullEventListener<V extends View> implements PullToRefreshBase.OnPullEventListener<V> {
	...
	private final HashMap<PullToRefreshBase.PtrState, Integer> mSoundMap;
	...
	public SoundPullEventListener(Context context) {
		mContext = context;
		mSoundMap = new HashMap<PtrState, Integer>();
	}

	@Override
	public final void onPullEvent(PullToRefreshBase<V> refreshView, PtrState event, PullToRefreshBase.PtrMode direction) {
	 ...
	 */
	public void addSoundEvent(PtrState event, int resId) {
