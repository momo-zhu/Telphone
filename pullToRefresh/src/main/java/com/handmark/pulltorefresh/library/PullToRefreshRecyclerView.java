...
public class PullToRefreshRecyclerView extends PullToRefreshBase<RecyclerView> {
    ...
    public PullToRefreshRecyclerView(Context context, PtrMode ptrMode) {
        super(context, ptrMode);
    }

    public PullToRefreshRecyclerView(Context context, PtrMode ptrMode, AnimationStyle style) {
    ...
    protected boolean isReadyForPullStart() {
        ...
        if (firstVisiblePosition == 0) {
            ...
            return view.getTop() == mRefreshableView.getPaddingTop() + ((MarginLayoutParams)view.getLayoutParams()).topMargin;
        }
        return false;
