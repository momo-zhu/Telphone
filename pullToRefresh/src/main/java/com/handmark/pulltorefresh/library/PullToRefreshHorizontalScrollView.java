...
public class PullToRefreshHorizontalScrollView extends PullToRefreshBase<HorizontalScrollView> {
	...
	public PullToRefreshHorizontalScrollView(Context context, PtrMode ptrMode) {
		super(context, ptrMode);
	}

	public PullToRefreshHorizontalScrollView(Context context, PtrMode ptrMode, AnimationStyle style) {
